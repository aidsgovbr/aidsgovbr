        ...
        <div class="col-sm-8 info">
          <div class="site-info">
            ...
            <a href="<?php print $front_page ?>">
              <span class="designation"><?php print t('Department of'); ?></span>
              <h1 class="site-name"><?php print t('STD, AIDS and Viral Hepatitis'); ?></h1>
              <span class="subordination"><?php print t('Ministry of Health'); ?></span>
            </a>
          </div>
        </div>
        <div class="col-sm-4">
