        ...
        <div class="col-sm-8 info">
          <div class="site-info">
            ...
            <a href="<?php print $front_page ?>">
              <span class="designation"><?php print t('info_designation'); ?></span>
              <h1 class="site-name"><?php print t('site_name'); ?></h1>
              <span class="subordination"><?php print t('info_subordination'); ?></span>
            </a>
          </div>
        </div>
        <div class="col-sm-4">
